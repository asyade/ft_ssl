...
void            ft_sha2(u8 *input, usize ilen, t_digest32 *output, u32 initial[8])
{
    t_sha2_state    state;

    ft_dig32_set(&state.h, initial);
...
{
    ft_sha2(input, ilen, output, (u32[]){0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19});
}

void            ft_sha224(u8 *input, usize ilen, t_digest32 *output)
{
    ft_sha2(input, ilen, output, (u32[]){ 0xc1059ed8, 0x367cd507, 0x3070dd17, 0xf70e5939, 0xffc00b31, 0x68581511, 0x64f98fa7, 0xbefa4fa4 });
}
